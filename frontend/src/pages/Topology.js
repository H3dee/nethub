...
class Topology extends Component {
      ...
      return (
        <div key={key} style={style} className="champ margin-bottom-20">
          <div className="champ-up centering-vertically">
            ...
            <div
              functional={`${index + 1}, ${this.state.stands[index + 1].id}`}
              className="icon icon-bin"
              onClick={this.standRemove}
            ></div>
          </div>
          <div className="champ-down centering-vertically">
            <div className="input margin-bottom-20">
              ...
              <input
                ...
                value={this.state.stands[index + 1].Address}
                onChange={(event) => {
                  this.setState({
                    stands: {
                      ...this.state.stands,
            ...
            <div className="input margin-bottom-20">
              ...
              <input
                className="input-field"
                value={this.state.stands[index + 1].Datacenter}
                onChange={(event) => {
                  this.setState({
                    stands: {
                      ...this.state.stands,
            ...
            <div className="input margin-bottom-20">
              ...
              <input
                className="input-field"
                value={this.state.stands[index + 1].Esxiuser}
                onChange={(event) => {
                  this.setState({
                    stands: {
                      ...this.state.stands,
            ...
            <div className="input margin-bottom-20">
              ...
              <input
                className="input-field"
                value={this.state.stands[index + 1].Esxipass}
                onChange={(event) => {
                  this.setState({
                    stands: {
                      ...this.state.stands,
            ...
            <div className="input margin-bottom-20">
              ...
              <input
                className="input-field"
                value={this.state.stands[index + 1].Digi}
                onChange={(event) => {
                  this.setState({
                    stands: {
                      ...this.state.stands,
            ...
            <div className="input margin-bottom-20">
              ...
              <input
                className="input-field"
                value={this.state.stands[index + 1].Email}
                onChange={(event) => {
                  this.setState({
                    stands: {
                      ...this.state.stands,
            ...
            <div className="input margin-bottom-20">
              ...
              <input
                className="input-field"
                value={this.state.stands[index + 1].Digiuser}
                onChange={(event) => {
                  this.setState({
                    stands: {
                      ...this.state.stands,
            ...
            <div className="input margin-bottom-20">
              ...
              <input
                className="input-field"
                value={this.state.stands[index + 1].Digipass}
                onChange={(event) => {
                  this.setState({
                    stands: {
                      ...this.state.stands,
            ...
            {Object.entries(this.state.devices).map(([keyd, valued]) => {
              if (
                valued.vm &&
                (valued.name === 'router' ||
                  valued.name === 'asa-5500' ||
                  valued.name === 'layer-3-switch' ||
                  valued.name === 'workgroup-switch' ||
                  valued.name === 'firewall')
              ) {
                return (
                  <div key={keyd} className="input margin-bottom-20">
                    <div className="input-header margin-bottom-8">{valued.vm} port</div>
                    <input
                      className="input-field"
                      value={this.state.stands[index + 1].Port[valued.vm]}
                      onChange={(event) => {
                        this.setState({
                          stands: {
                            ...this.state.stands,
                            [index + 1]: {
                              ...this.state.stands[index + 1],
                              Port: {
                                ...this.state.stands[index + 1].Port,
                                [valued.vm]: event.target.value,
                              },
                            },
                          },
                        });
    ...
    if (data !== {}) {
      Object.entries(data).map(([key, value]) => {
        if (
          ...
          (value.name === 'router' ||
            value.name === 'asa-5500' ||
            value.name === 'layer-3-switch' ||
            value.name === 'workgroup-switch' ||
            value.name === 'firewall')
        ) {
    ...
    data
      .then((res) => {
        ...
        Object.entries(this.state.champs).map(([key]) => {
          this.setState({
            champs: { ...this.state.champs, [key]: { ...this.state.champs[key], hide: 50 } },
          });
        });
      })
      .catch((res) => {
  ...
  gridMove(event) {
    this.setState({
      grid: [
        this.state.grid[0] + event.movementX / this.state.grid[2],
        this.state.grid[1] + event.movementY / this.state.grid[2],
        this.state.grid[2],
      ],
    });
  }
  ...
  createLine(event) {
    if (event.target.getAttribute('device')) {
      if (
        Object.entries(this.state.lines)[Object.keys(this.state.lines).length - 1] === undefined
      ) {
        this.setState({
          lines: {
            ...this.state.lines,
        ...
        Object.entries(this.state.lines)[Object.keys(this.state.lines).length - 1][1].length ===
          1 &&
        Object.entries(this.state.lines)[Object.keys(this.state.lines).length - 1][1][0] !==
          event.target.getAttribute('device')
      ) {
        this.setState({
          lines: {
            ...this.state.lines,
            [Object.keys(this.state.lines)[Object.keys(this.state.lines).length - 1]]: [
              ...this.state.lines[
                Object.keys(this.state.lines)[Object.keys(this.state.lines).length - 1]
              ],
              event.target.getAttribute('device'),
  ...
  panelClick(event) {
    if (event.nativeEvent.which === 1) {
      if (event.target.getAttribute('functional') === 'centering') {
        this.setState({
          grid: [window.innerWidth / 2, window.innerHeight / 2, this.state.grid[2]],
        });
      } else if (event.target.getAttribute('functional') === 'zoom') {
        if (this.state.grid[2] < 2) {
          this.setState({
            grid: [this.state.grid[0], this.state.grid[1], this.state.grid[2] + 0.1],
          });
        }
        ...
        this.error_counter = 0;
        let a = api.MakeSaveRequest(
          this.state.editTopology,
          this.state.devices,
          this.state.lines,
          this.state.ruzilDevices,
  ...
  deviceClick(event) {
    if (
      event.target.className.split(' ')[1] !== 'device-cloud' ||
      event.target.className.split(' ')[1] !== 'dot'
    ) {
    ...
    this.setState({
      devices: {
        ...
        [this.state.draggable]: {
          ...
          x:
            event.pageX / this.state.grid[2] -
            (this.state.grid[0] -
              (window.innerWidth - window.innerWidth / this.state.grid[2]) / 2) -
            35,
          y:
            event.pageY / this.state.grid[2] -
            (this.state.grid[1] -
              (window.innerHeight - window.innerHeight / this.state.grid[2]) / 2) -
            35,
        },
      },
    });
  ...
  moduleClick(event) {
    if (
      event.target.className.split(' ')[0] === 'champ-down' ||
      event.target.className.split(' ')[0] === 'title-small'
    ) {
      this.setState({
        editTopology:
          this.state.champs[event.target.getAttribute('functional').split(', ')[0]].Moduls[
            event.target.getAttribute('functional').split(', ')[1]
          ].Topology,
      });
      let data = api.GetModule(
        this.state.champs[event.target.getAttribute('functional').split(', ')[0]].Moduls[
          event.target.getAttribute('functional').split(', ')[1]
        ].Topology,
      );
      data
        .then((data) => {
          ...
          this.setState({
            ...
            ruzilDevices: data.data.Keys,
          });
          this.countDevices(data.data.Devices);
        })
        .catch((data) => {
          console.error(
            `Error at GetModule with module name being ${
              this.state.champs[event.target.getAttribute('functional').split(', ')[0]].Moduls[
                event.target.getAttribute('functional').split(', ')[1]
              ].Topology
            }`,
  ...
  topologyClick(event) {
    ...
    api
      .TopologyCreate(this.state.topologysValue)
  ...
  champAdd(event) {
    this.setState({
      champs: {
        ...this.state.champs,
        [Object.keys(this.state.champs).length]: {
          name: this.state.champValue,
          Moduls: {},
          hide: 50,
        },
      },
    ...
    api
      .ChampCreate(this.state.champValue)
  ...
  moduleAdd(event) {
    ...
    api
      .ModuleCreate(this.state.champs[this.state.selectModule[0]].name, this.state.moduleValue)
  ...
  removeChamp(event) {
    api
      .ChampRemove(event.target.getAttribute('functional').split(', ')[1])
  ...
  removeModule(event) {
    ...
    api
      .ModuleRemove(
        event.target.getAttribute('functional').split(', ')[1],
        event.target.getAttribute('functional').split(', ')[2],
      )
      .catch((err) =>
        console.error(
          `Error at ModuleRemove with champname ${
            event.target.getAttribute('functional').split(', ')[1]
          } and modulename ${event.target.getAttribute('functional').split(', ')[2]}`,
          err.data,
        ),
      );
    const copy = {
  ...
  removeTopology(event) {
    api
      .TopologyRemove(event.target.getAttribute('functional'))
      .error((err) =>
        console.error(
          `Error at TopologyRemove with topologyname ${event.target.getAttribute('functional')}`,
          err.data,
        ),
      );
    this.setState({
  ...
  topologySelect(event) {
    if (
      ...
      let data = api.TopologyLink(
        this.state.selectModule[2],
        this.state.selectModule[1],
        event.target.getAttribute('functional'),
      );
      data
        .then((data) => {
        ...
        .catch((data) => {
          console.error(
            `error at TopologyLink with champname ${this.state.selectModule[2]}, modulename ${
              this.state.selectModule[1]
            } and topologyname ${event.target.getAttribute('functional')}`,
            data.data,
          );
        });
      this.setState({
  ...
  standAdd(event) {
    ...
    data
      ...
      .catch((data) => {
        console.error(
          `Error at StandAdd with champname ${this.state.selectModule[2]} and modulename ${this.state.selectModule[1]}`,
          data.data,
        );
      });
  }
  ...
  standRemove(event) {
    api
      .StandRemove(
        this.state.selectModule[2],
        this.state.selectModule[1],
        parseInt(event.target.getAttribute('functional').split(', ')[1]),
      )
      .catch((err) =>
        console.error(
          `Error at StandRemove with champname ${this.state.selectModule[2]}, modulename ${
            this.state.selectModule[1]
          } and standid ${parseInt(event.target.getAttribute('functional').split(', ')[1])}`,
          err.data,
        ),
      );
        ...
        <ContinuousAuthObserver className="full-screen">
                ...
                <div className="modal-window-content">
                  <div className="input">
                    ...
                    <input
                      type="text"
                      className="input-field"
                      onChange={this.window}
                      value={this.state.devices[this.state.settings.name].vm}
                    />
                  </div>
                </div>
                <div className="modal-window-bottom">
                  <button className="button button-error" functional="cancel" onClick={this.window}>
                    Очистить
                  </button>
                  <button
                    className="button button-base margin-left-10"
                    functional="save"
                    onClick={this.window}
                  >
                    Сохранить
              ...
              <div className="modal-window modal-window-content">
                ...
                {Object.entries(this.state.champs).map(([key, value]) => {
                  return (
                    <div
                      key={key}
                      className="champ margin-bottom-20"
                      style={{ maxHeight: value.hide }}
                    >
                      <div className="champ-up centering-vertically">
                        <div functional={key} className="title margin-left-10">
                          {value.name}
                        </div>
                        <div
                          functional={`${key}, ${value.name}`}
                          className="icon icon-bin"
                          onClick={this.removeChamp}
                        ></div>
                        <div
                          functional={key}
                          className="icon icon-right icon-arrow"
                      ...
                      {Object.entries(value.Moduls).map(([keym, valuem]) => {
                        return (
                          <div
                            functional={`${key}, ${keym}, ${value.name}`}
                            key={keym}
                            onClick={valuem.Topology && this.moduleClick}
                            onMouseDown={this.select}
                            className="champ-down centering-vertically"
                          >
                            <div
                              className={`title-small margin-left-20 ${
                                !valuem.Topology && 'title-small-error'
                              }`}
                              functional={`${key}, ${keym}, ${value.name}`}
                            >
                              Module {keym} ({valuem.Topology ? valuem.Topology : 'none'})
                            </div>
                            <div
                              className="icon icon-bin"
                              functional={`${key}, ${value.name}, ${keym}`}
                              onClick={this.removeModule}
                            ></div>
                            <div
                              className="icon icon-right icon-pencil"
                              functional={`${key}, ${keym}, ${value.name}`}
                              onClick={this.moduleCreate}
                            ></div>
                          </div>
                        );
                      })}
                      <div
                        key={key}
                        className="champ-down centering-vertically"
                        functional={`${key}, add, ${value.name}`}
                        onClick={this.addModule}
                        onMouseDown={this.select}
                      >
                        <div className="title-small margin-left-20" functional={`${key}, add`}>
                          Add Module
                        </div>
                ...
                <div className="champ">
                  <div
                    className="champ-up centering-vertically margin-bottom-20"
                    onClick={this.champCreate}
                  >
                    <div className="title margin-left-10">Add Champ</div>
                    <div className="icon icon-add"></div>
                  </div>
                </div>
                <Link to="/main" className="button button-base centering margin-bottom-20">
                  Перейти к главной странице
                </Link>
                <Link to="/admin" className="button button-base centering margin-bottom-20">
                  Перейти к админке
                </Link>
                <button className="button button-error" onClick={this.Exit}>
                  Выйти в окно
                </button>
              </div>
            </div>
              ...
              <div className="modal-window modal-window-content z-index">
                ...
                <div className="champ margin-bottom-20">
                  {this.state.topologys.map((value) => {
                    return (
                      ...
                      >
                        <div functional={value} className="title-small margin-left-20">
                          {value}
                        </div>
                        <div
                          functional={value}
                          className="icon icon-bin"
                          onClick={this.removeTopology}
                        ></div>
                ...
                <div className="input margin-bottom-20">
                  ...
                  <input
                    ...
                    value={this.state.topologysValue}
                  />
                </div>
                <button className="button button-base margin-bottom-8" onClick={this.topologyClick}>
                  Создать
                </button>
              </div>
            </div>
          ...
          {this.state.addModule && (
            <div className="full-screen centering">
              ...
              <div className="modal-window modal-window-content z-index">
                ...
                <button className="button button-base margin-bottom-8" onClick={this.moduleAdd}>
                  Создать
                </button>
              </div>
            </div>
          ...
          {this.state.champCreate && (
            <div className="full-screen centering">
              <div className="block-content" onClick={this.backgroundClick}></div>
              <div className="modal-window modal-window-content z-index">
                <div className="title centering-horizontally margin-bottom-20">
                  Добавить чемпионат
                </div>
                <div className="input margin-bottom-20">
                ...
                <button className="button button-base margin-bottom-8" onClick={this.champAdd}>
                  Создать
                </button>
              </div>
            </div>
          ...
          <div className="device-header">
            <div
              component="router"
              className="device device-router"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="asa-5500"
              className="device device-asa-5500 margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="workgroup-switch"
              className="device device-workgroup-switch margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="layer-3-switch"
              className="device device-layer-3-switch margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="pc"
              className="device device-pc margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="laptop"
              className="device device-laptop margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="voltage"
              className="device device-voltage-top margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="fileserver"
              className="device device-fileserver margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="firewall"
              className="device device-firewall margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="cloud"
              className="device device-cloud-top margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="input"
              className="device device-input margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="input-red"
              className="device device-input-red margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="input-mini"
              className="device device-input-mini margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="input-mini-rotate"
              className="device device-input-mini-rotate margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="input-mini-rotate-30"
              className="device device-input-mini-rotate-30 margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="input-mini-rotate-330"
              className="device device-input-mini-rotate-330 margin-left-10"
              onMouseDown={this.draggableDevice}
            />
            <div
              component="dot"
              className="device device-dot margin-left-10"
              onMouseDown={this.draggableDevice}
            />
          </div>
          <div className="left-panel" onClick={this.panelClick}>
            ...
            <div
              functional="zoom"
              className="left-panel_button left-panel_button_zoom margin-bottom-8"
            />
            <div
              functional="reduce"
            ...
            <div
              functional="line"
              className="left-panel_button left-panel_button_line margin-bottom-8"
            />
          ...
          <div className="right-panel">
            ...
            <button className="button button-base margin-bottom-8" onClick={this.standAdd}>
              Добавить стенд
            </button>
          </div>
          <div
                ...
                if (value.name === 'input') {
                  ...
                  return (
                    <input
                      ...
                      key={key}
                      device={key}
                      className="input-grid-mini-rotate"
                      placeholder="TEXT"
                      onChange={this.changeText}
                      value={this.state.devices[key].text}
                      style={{ left: value.x, top: value.y }}
                  ...
                  return (
                    <input
                      ...
                      key={key}
                      device={key}
                      className="input-grid-mini-rotate-30"
                      placeholder="TEXT"
                      onChange={this.changeText}
                      value={this.state.devices[key].text}
                      style={{ left: value.x, top: value.y }}
                  ...
                  return (
                    <input
                      ...
                      key={key}
                      device={key}
                      className="input-grid-mini-rotate-330"
                      placeholder="TEXT"
                      onChange={this.changeText}
                      value={this.state.devices[key].text}
                      style={{ left: value.x, top: value.y }}
                ...
                {Object.entries(this.state.lines).map(([key, value]) => {
                  if (value[1] && this.state.devices[value[0]].name === 'input') {
                    return (
                      <line
                        key={key}
                        x1={this.state.devices[value[0]].x}
                        y1={this.state.devices[value[0]].y + 30}
                        x2={this.state.devices[value[1]].x + 35}
                        y2={this.state.devices[value[1]].y + 35}
                        className="line"
                      />
                    );
                  } else if (
                    value[1] &&
                    this.state.devices[value[0]].name !== 'cloud' &&
                    this.state.devices[value[1]].name !== 'cloud'
                  ) {
                    return (
                      <line
                        key={key}
                        x1={this.state.devices[value[0]].x + 35}
                    ...
                    return (
                      <line
                        key={key}
                        x1={this.state.devices[value[0]].x + 100}
                    ...
                    return (
                      <line
                        ...
                        y2={this.state.devices[value[1]].y + 50}
                        className="line"
                      />
                    );
                  } else if (

...
class Registration extends Component {
  ...
  checkFields() {
    ...
    if (
      this.state.name.match('^[А-Я][А-Яа-я\\-]{1,}\\s[А-Я][А-Яа-я]{1,}\\s[А-Я][А-Яа-я]{1,}$') !=
      null
    ) {
      ...
      this.setState({
        error_name:
          'Введите ФИО в формате "Фамилия Имя Отчество" (Каждое слово должно начинаться с заглавной буквы и состоять из русских букв).',
      });
      check++;
    }

    ...
    return (
      <div className="full-screen">
        ...
        <div className="content content_48px top-48">
          {this.state.nochamps ? (
            <div className="title margin-left-20">You don't have championships assigned</div>
          ) : (
            Object.entries(this.state.champs).map(([key, value]) => {
              return (
                <div key={key} className="champ margin-bottom-20" style={{ maxHeight: value.hide }}>
                  ...
                  {value.Moduls === undefined ? (
                    <div className="champ-down centering-vertically">
                      <div className="title-small margin-left-20">
                        You don't have modules assigned
                      </div>
                    </div>
                  ) : (
